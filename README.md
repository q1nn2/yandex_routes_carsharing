...
### Чек‑лист вёрстки (Т1–Т60)

Оценка одинакова в **Firefox 800×600** и **Chrome 1920×1080** (как в исходной таблице).
...
| Passed | **32** |
| Failed | **18** |
| Skipped | **1** (Т17 — нет функции) |
| Blocked | **9** (Т52–Т60, Б19) |

### Чек‑лист «Способ оплаты» / «Добавление карты» (Т1–Т38), Chrome 1920×1080
...
### Тест‑кейсы кнопки «Забронировать»
